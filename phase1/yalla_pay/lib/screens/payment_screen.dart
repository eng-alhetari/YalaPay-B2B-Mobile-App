...
class _PaymentScreenState extends ConsumerState<PaymentScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('P A Y M E N T S', textAlign: TextAlign.center, style: TextStyle(fontSize: 30, color: Color.fromARGB(255, 121, 121, 121)),),
      ),
      body: Container(
        color: Colors.white,
        child: Expanded(
          child: Column(
            children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  IconButton(onPressed: (){
                                    context.pushNamed(AppRouter.editPayment.name, pathParameters: {'paymentId' : payment.id!, 'id' : widget.id});                                
                                  }, 
              ...
              ElevatedButton(
                  onPressed: (){
                    context.pushNamed(AppRouter.newPayment.name, pathParameters: {'invoiceId' : widget.id, 'id' : widget.id});
                  }, 
