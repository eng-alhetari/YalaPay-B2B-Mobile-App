...
class ChequeDetailsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ChequeDetailsScreen> createState() => _ChequeDetailsScreenState();
}
...
class _ChequeDetailsScreenState extends ConsumerState<ChequeDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('C H E Q U E   D E T A I L S', 
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...stylesDetails.chequeHeadingDetailEntry(heading: 'Amount', detail: 'QR ${cheque.amount}', icon: const Icon(Icons.monetization_on_outlined, color: Colors.grey,)),
                          ...stylesDetails.chequeHeadingDetailEntryWithBorder(
                            heading: 'Drawer Bank', 
