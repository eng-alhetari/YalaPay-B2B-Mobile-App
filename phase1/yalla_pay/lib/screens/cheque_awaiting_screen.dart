                    ...
                    child: SizedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          isWide ? TableEntry(content: cheques[index].drawer, color: Colors.indigo) : Container(),
                          isWide ? TableEntry(content: cheques[index].bankName, color: Colors.indigo) : Container(),
                          Expanded(
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                          ...
                          Row(
                            children: [
                              IconButton(onPressed: (){
                                Payment thisPayment = payments.firstWhere((p) => p.chequeNo == cheques[index].chequeNo);

                                context.pushNamed(AppRouter.editPayment.name, pathParameters: {'paymentId' : thisPayment.id!, 'id' : thisPayment.invoiceNo!});
                              }, 
