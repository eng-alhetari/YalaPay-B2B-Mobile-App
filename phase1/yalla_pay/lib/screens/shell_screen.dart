...
class _ShellScreenState extends ConsumerState<ShellScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Row(
        children: [
          login && (deviceData.size.width >= 500) ?
          NavigationRail(
            ...
            login && (deviceData.size.width >= 500) ? const VerticalDivider() : Container(), 
          Expanded(child: widget.child),
        ]
        ),
      
      bottomNavigationBar: login && (deviceData.size.width < 500) ? BottomNavigationBar(
