...
class _ChequesReportScreenState extends ConsumerState<ChequesReportScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_fromDateController.text.isNotEmpty &&
      ...
      if (DateTime.parse(_fromDateController.text)
          .isAfter(DateTime.parse(_toDateController.text))) {
        validReport = false;
      } else {
        validReport = true;
      }
            ...
            children: [
                      ...
                      ...List.generate(chequeStatuses.length, (index) {
                        return Row(
                          children: [
                            ...
                            Text(
                              chequeStatuses[index],
                              style: stylesDetails.detailStyle(colors[index]!),
                            ),
                          ],
                        );
                      })
                          ...
                          onPressed: () {
                            setState(() {
                              ...
                              if (selectedOption != "All") {
                                pickedColor =
                                    chequeStatuses.indexOf(selectedOption);
                                filteredCheques = cheques
                                    .where((c) => c.status == currentOption)
                                    .toList();
                                if (filteredCheques.isNotEmpty) {
                                  totalAmount = filteredCheques
                                      .map(
                                        (e) => e.amount,
                                      )
                                      .reduce((a, b) => a + b);
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    '  Total   ',
                    style: stylesDetails.largerHeadingStyle(
                        const Color.fromARGB(255, 122, 122, 122)),
                  ),
                ],
              ),
                      ...
                      children: [
                        Container(
                            ...
                            child: Text(
                              ...
                              style:
                                  stylesDetails.largerDetailStyle(Colors.white),
                            )),
                        const SizedBox(
                          height: 40,
                        ),
                  ...
                  : Column(
                      children: [
                        Row(
                          ...
                          children: [
                            ...List.generate(colors.length, (index) {
                              ...
                              if (filteredCheques
                                  .where(
                                      (e) => e.status == chequeStatuses[index])
                                  .isNotEmpty) {
                                thisTotal = filteredCheques
                                    .where((e) =>
                                        e.status == chequeStatuses[index])
                                    .map(
                                      (e) => e.amount,
                                    )
                                    .reduce((a, b) => a + b);
                              ...
                              return Container(
                                  ...
                                  child: Text(
                                    ' QR ${thisTotal.toStringAsFixed(2)} ',
                                    style:
                                        stylesDetails.detailStyle(Colors.white),
                                  ));
                            })
                          ],
                        ),
                        ...
                        SizedBox(
                          ...
                          child: Expanded(
                              child: Text(
                            'Note: Results are color coded! Refer to the status colors.',
                            style: stylesDetails.detailStyle(
                                const Color.fromARGB(255, 122, 122, 122)),
                            textAlign: TextAlign.center,
                          )),
