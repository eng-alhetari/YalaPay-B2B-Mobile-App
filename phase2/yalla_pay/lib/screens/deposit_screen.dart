              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      color:
                          alternator == 0 ? Colors.blue[100] : Colors.blue[50],
                      elevation: 5,
                      child: SizedBox(
                        height: 55,
                        child: Row(
                          ...
                          children: [
                                  ...
                                  children: [
                                    Expanded(
                                      child: IconButton(
                                          onPressed: () {
                                            context.pushNamed(
                                                AppRouter.depositDetails.name,
                                                pathParameters: {
                                                  'id': deposits[index].id!
                                                });
                                          },
                            ...
                            TableEntry(
                                content:
                                    format.format(deposits[index].depositDate),
                                color: Colors.indigo),
                            TableEntry(
                                content: deposits[index].bankAccountNo,
                                color: Colors.indigo),
                            TableEntry(
                                content: '${deposits[index].chequeNos.length}',
                                color: Colors.indigo),
                            TableEntry(
                                content: '${deposits[index].chequeNos.reduce(
