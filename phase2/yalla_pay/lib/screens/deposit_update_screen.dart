...
class DepositUpdateScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DepositUpdateScreen> createState() =>
      _DepositUpdateScreenState();
}
      ...
      data: (deposits) {
        ...
        if (selectedReasons.isEmpty && currentOption == "Cashed with Returns") {
          for (int chequeNo in deposit.chequeNos) {
            loadedCheques.add(cheques.value!.firstWhere((e) =>
                e.chequeNo ==
                chequeNo)); // NOTE: USED .value! , might cause errors
            selectedReasons.add('');
          }
        }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ...stylesDetails.headingDetailEntry(
                            ...
                            detail: format.format(deposit.depositDate),
                            icon: const Icon(
                                        ...
                                        Expanded(
                                          child: Column(
                                            mainAxisAlignment:
                                                MainAxisAlignment.center,
                                            children: [
                                              ...stylesDetails.cardHeadingDetailEntry(
                                                  heading:
                                                      depositCheque.bankName,
                                                  detail:
                                                      'Drawer: ${depositCheque.drawer}',
                    ...
                    onPressed: () {
                      setState(() {
                        ...
                        for (var c in loadedCheques) {
                          if ((currentOption == "Cashed with Returns" &&
                                  selectedReasons[loadedCheques.indexOf(c)]
                                      .isEmpty) ||
                              currentOption == "Cashed") {
                            print(currentOption);
                            ref
                                .watch(chequeNotifierProvider.notifier)
                                .updateChequeStatus(c.chequeNo!, "Cashed");
                            ref
                                .watch(chequeNotifierProvider.notifier)
                                .updateChequeCashedDate(c.chequeNo!,
                          ...
                          if (currentOption == "Cashed with Returns" &&
                            ...
                            ref
                                .watch(chequeNotifierProvider.notifier)
                                .updateChequeStatus(c.chequeNo!, "Returned");
                            ref
                                .watch(chequeNotifierProvider.notifier)
                                .updateChequeReturnReason(c.chequeNo!,
                                    selectedReasons[loadedCheques.indexOf(c)]);
                          }
                        }
                        ...
                        ref
                            ...
                            .updateDepositStatus(deposit.id!, currentOption);
                        ref
                            .read(chequeDepositNotifierProvider.notifier)
                            .updateDepositCashedDate(deposit.id!,
                                DateTime.parse(_dateController.text));
                        context.pop();
                      });
                    },
