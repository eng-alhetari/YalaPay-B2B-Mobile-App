...
class DepositDetailsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DepositDetailsScreen> createState() =>
      _DepositDetailsScreenState();
}
            ...
            child: Expanded(
              child: Column(
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ...stylesDetails.headingDetailEntryWithBorder(
                            ...
                            backgroundColor:
                                const Color.fromARGB(255, 211, 255, 231),
                  ...
                  cheques.when(
                    data: (cheques) => Expanded(
                      child: Padding(
                        padding: const EdgeInsets.only(left: 16.0, right: 16.0),
                        child: ListView.builder(
                          itemCount: deposit.chequeNos.length,
                          itemBuilder: (context, index) {
                            var depositCheque = cheques.firstWhere(
                              (element) =>
                                  element.chequeNo == deposit.chequeNos[index],
                            );
                                    ...
                                    children: [
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...stylesDetails.cardHeadingDetailEntry(
                                                heading: depositCheque.bankName,
                                                detail:
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...stylesDetails
                                                .cardHeadingDetailEntryWithBorder(
                                                    heading:
                                                        '${depositCheque.amount}',
                                                    detail:
                                                        depositCheque.status,
                                                    icon: const Icon(Icons
