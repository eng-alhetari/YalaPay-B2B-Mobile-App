                          ...
                          return Row(
                            children: [
                              ...
                              Text(
                                ...
                                style:
                                    stylesDetails.detailStyle(colors[index]!),
                              ),
                            ],
                          );
                        })
                            ...
                            onPressed: () {
                              setState(() {
                                ...
                                for (var invoice in invoices) {
                                  var temp = payments
                                      .where((e) => e.invoiceNo == invoice.id)
                                      .toList();
                                  if (temp.isNotEmpty) {
                                    if (invoice.amount -
                                            temp
                                ...
                                if (selectedOption != "All") {
                                  pickedColor =
                                      invoiceStatuses.indexOf(selectedOption);
                        ...
                        children: [
                          Container(
                              ...
                              child: Text(
                                ...
                                style: stylesDetails
                                    .largerDetailStyle(Colors.white),
                              )),
                          const SizedBox(
                            height: 40,
                          ),
                    ...
                    : Column(
                        children: [
                          Row(
                            ...
                            children: [
                              ...List.generate(colors.length, (index) {
                                ...
                                if (filteredInvoices
                                    .where((e) =>
                                        e.status == invoiceStatuses[index])
                                    .isNotEmpty) {
                                  thisTotal = filteredInvoices
                                      .where((e) =>
                                          e.status == invoiceStatuses[index])
                                      .map(
                                        (e) => e.amount,
                          ...
                          Row(
                            ...
                            children: [
                              ...List.generate(colors.length, (index) {
                                int thisCount = filteredInvoices
                                    .where((e) =>
                                        e.status == invoiceStatuses[index])
                                    .length;
                                return Container(
                          ...
                          Container(
                              ...
                              child: Text(
                                '  QR ${grandTotal.toStringAsFixed(2)}  ',
                                style: stylesDetails
                                    .largerDetailStyle(Colors.white),
                              )),
                          const SizedBox(
